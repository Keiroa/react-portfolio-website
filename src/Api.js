...
const Api = {
  ...
  vocabularies: {
    index() {
      return instance.get('/api/vocabularies');
    },
    get(id) {
      return instance.get(`/api/vocabularies/${id}`);
    },
    create(data) {
      return instance.post('/api/vocabularies', data);
    },
    update(id, data) {
      return instance.patch(`/api/vocabularies/${id}`, data);
    },
    delete(id) {
      return instance.delete(`/api/vocabularies/${id}`);
    },
  },
  passwords: {
    reset(email) {
